...
- Derive stage-level durations from those markers in `langchain-v1/trading_service.py`.
...
```bash
python -m py_compile /Users/linyuxuan/workSpace/FinGOAT/TradingAgents/tradingagents/graph/setup.py /Users/linyuxuan/workSpace/FinGOAT/langchain-v1/trading_service.py /Users/linyuxuan/workSpace/FinGOAT/langchain-v1/tests/mock_pipeline/test_mock_analysis_pipeline.py
