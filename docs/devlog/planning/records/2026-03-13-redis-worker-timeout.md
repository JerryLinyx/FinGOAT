...
- `langchain-v1/tests/mock_pipeline/test_redis_worker_client.py`
...
```bash
python -m py_compile /Users/linyuxuan/workSpace/FinGOAT/langchain-v1/trading_service.py /Users/linyuxuan/workSpace/FinGOAT/langchain-v1/tests/mock_pipeline/test_redis_worker_client.py
cd /Users/linyuxuan/workSpace/FinGOAT/langchain-v1 && python -m unittest tests.mock_pipeline.test_redis_worker_client tests.mock_pipeline.test_mock_analysis_pipeline
```
