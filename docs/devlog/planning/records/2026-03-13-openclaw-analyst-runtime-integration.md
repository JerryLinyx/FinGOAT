...
- `python -m py_compile langchain-v1/trading_service.py TradingAgents/tradingagents/openclaw/adapter.py TradingAgents/tradingagents/graph/setup.py TradingAgents/tradingagents/graph/trading_graph.py TradingAgents/tradingagents/default_config.py`
