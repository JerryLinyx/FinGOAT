...
```bash
python -m py_compile /Users/linyuxuan/workSpace/FinGOAT/TradingAgents/tradingagents/graph/trading_graph.py /Users/linyuxuan/workSpace/FinGOAT/langchain-v1/trading_service.py /Users/linyuxuan/workSpace/FinGOAT/langchain-v1/tests/mock_pipeline/test_mock_analysis_pipeline.py
cd /Users/linyuxuan/workSpace/FinGOAT/langchain-v1 && python -m unittest tests.mock_pipeline.test_mock_analysis_pipeline tests.mock_pipeline.test_redis_worker_client
```
