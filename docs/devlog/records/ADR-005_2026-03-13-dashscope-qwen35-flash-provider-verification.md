...
id: ADR-005
kind: review
title: DashScope qwen3.5-flash Provider Verification
date: 2026-03-13
status: active
supersedes: null
superseded_by: null
...
- `services/trading-service/trading_service.py` loads `.env` at startup and accepts request-level provider/model overrides.
