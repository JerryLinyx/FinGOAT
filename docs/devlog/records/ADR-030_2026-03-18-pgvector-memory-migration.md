...
id: ADR-030
kind: decision
title: pgvector Memory Store Migration
date: 2026-03-18
status: active
supersedes: null
superseded_by: null
...
The current version requirement context for this work is tracked in `../current/prd.md`.
...
`services/python-common/requirements.txt`: Added `psycopg2-binary>=2.9.9` and `pgvector>=0.3.0`.
